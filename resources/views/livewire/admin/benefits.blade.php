    ...
    <form wire:submit.prevent="submit">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            {{-- <div>
                ...
                <input type="text" id="barangay" wire:model="barangay" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
        ...
        <div class="mt-6">
            <button type="submit"
                ...
                {{ $benefitId ? 'bg-green-600 hover:bg-green-700' : 'bg-indigo-600 hover:bg-indigo-700' }}
                shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2
                {{ $benefitId ? 'focus:ring-green-500' : 'focus:ring-indigo-500' }}">

                {{ $benefitId ? 'Update Benefits' : 'Add Benefits' }}
            </button>
        </div>
    </form>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-800">
                    <tr>
                        ...
                        {{-- <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Barangay</th> --}}
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($benefits as $benefit)
                        <tr>
                            ...
                            {{-- <td class="px-6 py-4 whitespace-nowrap">{{ $benefit->barangay }}</td> --}}
